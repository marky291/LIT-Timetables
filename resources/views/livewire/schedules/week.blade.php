<div>
    ...
    @if ($days->count())
        @foreach ($days as $key => $day)
            ...
            <div class="p-4 bg-white dark:bg-dark-panel border dark:border-dark-border rounded-lg shadow px-10 py-6 {{ $loop->first ? '' : 'mt-7' }}">

                <div class="prose mb-3">
                    <h3 class="text-xl font-medium leading-6 text-gray-900 dark:text-dark-text">{{ $days[$key][0]->starting_date->isoformat('dddd, Do MMMM') }}</h3>
                </div>
                                        ...
                                        <div class="relative flex space-x-3">
                                            <div class="flex items-center">
                                                @switch($schedule->type->name)
                                                    ...
                                                    <span class="flex items-center justify-center w-8 h-8 text-white bg-red-500 rounded-full ring-8 ring-white dark:ring-dark-panel">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-white" viewBox="0 0 20 20" fill="currentColor">
                                                    ...
                                                    @case('Practical')
                                                    <span class="flex items-center justify-center w-8 h-8 text-white bg-green-500 rounded-full ring-8 ring-white dark:ring-dark-panel">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    ...
                                                    @break
                                                    @case('Online Lecture')
                                                    <span class="flex items-center justify-center w-8 h-8 text-white bg-yellow-500 rounded-full ring-8 ring-white dark:ring-dark-panel">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    ...
                                                    <span class="flex items-center justify-center w-8 h-8 text-white bg-pink-500 rounded-full ring-8 ring-white dark:ring-dark-panel">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                  ...
                                                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222" />
                                                    ...
                                                    @break
                                                    @default
                                                    <span class="flex items-center justify-center w-8 h-8 text-white bg-blue-500 rounded-full ring-8 ring-white dark:ring-dark-panel">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        ...
                                                        <div class="p-3">
                                                            <div class="prose">
                                                                <p class="my-0 text-gray-800">
                                                                    <legend class="font-semibold dark:text-dark-text">{{ $schedule->module->name }}</legend>
        ...
        @endforeach
    @else
        <div class="p-4 bg-white dark:bg-dark-panel border dark:border-dark-border rounded-lg shadow px-10 py-6 text-center dark:text-dark-icon">
            <h3 class="text-xl">Great! There is nothing scheduled for this week!</h3>
        </div>
    @endif
</div>
