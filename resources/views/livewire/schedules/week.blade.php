<div>
    ...
    <div class="flex justify-around">
        ...
        class="w-48 inline-flex items-center px-3 py-2 mt-2 text-sm font-medium leading-4 text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm md:mt-0 dark:button dark:border-gray-600 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Previous</button>
        <p class="text-white text-xl">Viewing Academic Week {{ $viewing_week }}</p>
        <button wire:click="incrementWeek()"
        class="w-48 inline-flex items-center px-3 py-2 mt-2 text-sm font-medium leading-4 text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm md:mt-0 dark:button dark:border-gray-600 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Next</button>
    ...
    <div wire:loading class="w-full">
        <div class="p-4 flex items-center justify-center bg-white dark:text-dark-icon dark:bg-dark-panel border dark:border-dark-border rounded-lg shadow px-10 py-6">
            ...
            <h3 class="ml-4 text-xl text-center py-6">Fetching Timetable...</h3>
        </div>
    </div>
    ...
    <div wire:loading.remove>
        ...
        <div class="p-4 py-8 bg-white dark:bg-dark-panel border dark:border-dark-border rounded-lg shadow px-10 py-6 text-center dark:text-dark-icon">
            ...
            <h3 class="text-md mt-4 text-gray-500">Don't forget you can check whats happening next week.</h3>
        </div>
        @else
