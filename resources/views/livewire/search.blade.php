                            ...
                            <ul class="list-none">
                                @foreach ($this->searches->where('favorite', false) as $i => $model)
                                    <li class="relative mt-2">
                                        <div wire:key="search-{{ $loop->index }}" class="search-result-item" :class="{ 'search-result-item-selected': selected === {{$i}} }">
                                            ...
                                            <div class="search-result-icon" wire:loading.remove wire:click="favorite({{$model->id}})" >
