        ...
        <div class="w-full pt-16 pb-20 mx-auto text-center max-w-7xl lg:py-48 lg:text-left">
            <div class="px-4 lg:w-1/2 sm:px-8 xl:pr-16">
                <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl">
                    <span class="block xl:inline dark:text-dark-text">{{ __('Smarter approach to') }}</span>
                    <span class="block text-indigo-600 xl:inline">{{ __('LIT Timetables') }}</span>
                </h1>
                ...
                <div class="mt-10 sm:flex sm:justify-center lg:justify-start">
                    ...
                    <div class="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
                        <a dusk="href-learnmore" target="_blank" href="https://github.com/marky291/lit-timetables" class="dark:button flex items-center justify-center w-full px-8 py-3 text-base font-medium text-indigo-600 bg-white h-full rounded-md hover:bg-gray-50 md:py-4 md:text-lg md:px-10">
